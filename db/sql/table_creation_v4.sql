...
CREATE TABLE IF NOT EXISTS public.rule_tax_zone
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
...
(
    ...
    tax_zone character varying(10) COLLATE pg_catalog."default",
    tax_circle character varying(10) COLLATE pg_catalog."default",
    is_resident boolean,
    is_ff boolean,
    is_female boolean,
    is_disabled boolean,

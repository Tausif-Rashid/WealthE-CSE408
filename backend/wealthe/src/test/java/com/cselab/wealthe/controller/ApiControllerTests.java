...
//    }
    ...
    @Test
    void testGenerateUserInfoPdf_SuccessfulGeneration() throws Exception {
        // Arrange
        String expectedFilePath = "user_info_report.pdf";
        String expectedFileName = "user_info_report.pdf";

        when(pdfService.generateUserInfoPdf()).thenReturn(expectedFilePath);

        // Act
        ResponseEntity<Map<String, Object>> result = apiController.generateUserInfoPdf();
        ...
        assertNotNull(responseBody);
        assertTrue((Boolean) responseBody.get("success"));
        assertEquals("PDF generated successfully", responseBody.get("message"));
        assertEquals(expectedFilePath, responseBody.get("filePath"));
        assertEquals(expectedFileName, responseBody.get("fileName"));

        // Verify service interaction
        verify(pdfService).generateUserInfoPdf();
    }

    @Test
    void testGenerateUserInfoPdf_FilePathWithoutSeparator() throws Exception {
        // Arrange - file path without any separator (just filename)
        String expectedFilePath = "report.pdf";
    ...
    @Test
    void testGenerateUserInfoPdf_EmptyFilePathFromService() throws Exception {
        // Arrange
        ...
        assertEquals("PDF generated successfully", responseBody.get("message"));
        assertEquals(expectedFilePath, responseBody.get("filePath"));
        assertEquals("", responseBody.get("fileName"));
